...
<!-- Chi siamo Container -->
<div class="w3-container" id="about">
  <div class="w3-content" style="max-width:700px" id="team-section">
...
<!-- Footer 
<footer class="w3-center w3-black w3-padding-16 w3-small">
  <p class="w3-text-white">Contatti: <br>
