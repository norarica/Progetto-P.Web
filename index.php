...
<!-- Chi siamo Container -->
<div class="w3-container">
  <div class="w3-content" id="team-padding">
  
    <h5 class="titolo"><span class="w3-tag w3-wide">IL NOSTRO TEAM</span></h5>
    <div class="w3-row w3-center">
      <!-- Foto Pietro -->
      <div class="w3-col s4">
        <img src="https://c8.alamy.com/compit/j9caxx/animale-selvaggio-verticale-giraffe-animali-selvatici-africa-sud-africa-animale-j9caxx.jpg" 
        alt="Pietro" class="team-photo">
      ...
      <!-- Foto Nora -->
      <div class="w3-col s4">
        <img src="https://www.animalidacompagnia.it/wp-content/uploads/2018/04/maine-coon-verticale.jpg" 
        alt="Nora" class="team-photo">
...
<div class="w3-center" style="padding: 20px; padding-bottom: 35px; margin-top:3%">
  <a href="registra.html" class="w3-button w3-black w3-medium">Clicca qui per registrarti</a>
</div>
